...
<body>
    <!-- <div class="whole-page-wrapper">  -->
        ...
        <!-- <div class="home-page-first-section-bg">
            <img class="home-page-first-section-bg-img" src="assets/Home/blue2.png" alt="">
        </div>
        <div class="home-page-first-section-bg2">
            <img class="home-page-first-section-bg-img2" src="assets/Home/blue1.png" alt="">
        </div>
        <div class="home-page-first-section-bg3">
            <img class="home-page-first-section-bg-img3" src="assets/Home/blue2.png" alt="">
        </div>
        <div class="home-page-first-section-bg4">
            <img class="home-page-first-section-bg-img4" src="assets/Home/blue2.png" alt="">
        </div>
        <div class="home-page-first-section-bg5">
            <img class="home-page-first-section-bg-img5" src="assets/Home/blue1.png" alt="">
        </div> -->
        <div class="home-page-wrapper-for-bg">
    ...
    <div class="home-page-header-section">
        ...
        <div class="header-buttons">
            <div class="header-btn1">
                <button onclick="window.location.href='https://dev.savvy-srt.com/login'">
                    Get Started
...
<div class="be-complaint-section be-complaint-section-first" id="content">
    <div class="savvy-border-line" style="z-index:-10">
        <img src="assets/Home/Group 24.svg" alt="">
    </div>
    <div class="savvy-border-line2" style="z-index:-10">
        <img src="assets/Home/Group 24.svg" alt="">
    </div>
    
    <div class="be-complaint-text" style="z-index:10">
        <h1>Be Compliant</h1>
        <p><?= $webConfig['complaint'] ?></p>
        <a id="what-we-do-linkk"href="whatwedo.php">know more....</a>
    </div>
</div>

<div class="be-complaint-section be-complaint-section-second" id="content">
...
<div id="card-cont"class=" becomplaint-cards">
            <div  class="iitem-inside becomplaint-card ">
...
<div class="core-sevices-section" id="content">
    <div class="why-savvy-section">
        <h1 class="core-section-heading">Core Services Offering</h1> 
        <div class="savvy-border-line">
            <img src="assets/Home/Group 24.svg" alt="">
        </div>
        <div class="savvy-border-line2">
        ...
        <div class="core-services-section">
            ...
            ?>
                        <div class="core-card-<?=$cssName[$i]?>-row">
                            ...
                            <div class="why-card-text">
                                <h1><?=$serve['name']?> :</h1> <span><?=$serve['about']?></span>
                            </div>
                        </div>
            <?php
                $i++;
            ...
            ?>
            <!-- <div class="core-card-first-row">

                <div class="why-core">
                    <img src="assets/Home/24x7.png" alt="">
                </div>
                <div class="why-card-text">
                    <h1>License Management : <span>lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme lorme </span></h1>
                </div>
            </div>
            <div class="core-card-second-row">
            ...
            <div class="core-card-fourth-row">
...
<!-- ------------new-section-3-ends -->
<div class="new-savvy-container" id="content">
    <div class="why-savvy-section">
    <h1>Why Savvy- STR</h1>
            ...
            <?php if (isset($whyUs)) {
                ...
                foreach ($whyUs as $serve) { ?>
                            <div class="why-card why-card">
                                <img src="<?= $serve['icon'] ?>" alt="">
                                <h1><?= $serve['name'] ?></h1>
                                <p class="displayonhovercontent"><?= $serve['about'] ?></p>
                            </div>
                        <?php $i++;}
            } ?>
        </div>
...
<div class="our-client-section-speaks" id="content">
            <div class="savvy-border-line">
                <img src="assets/Home/Group 24.svg" alt="">
            </div>
            <div class="savvy-border-line2">
