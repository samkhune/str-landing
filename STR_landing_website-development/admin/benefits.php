...
if(isset($_POST['editTestimonial'])){
    ...
    $sql = "UPDATE benefits SET name = '$name' , thought = '$thought' WHERE id = '$id'";
    if($conn->query($sql)){
        $updated='true';
    }
    else{
...
if(isset($_POST['addTestimonial'])){
    ...
    $sql = "INSERT INTO benefits( name, thought) VALUES ('$name','$thought')";
    if($conn->query($sql)){
        $added='true';
    }
    else{
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pr-3">Benefits</div>
                <div class="pl-3">
            ...
            <div class="card-body">
                    <?php
                        if($updated == 'true'){
                            ?>
                                <div class="alert alert-primary">Benefits updated Successfully !</div>
                            <?php
                        }
                        ...
                        if($added == 'true'){
                            ?>
                                <div class="alert alert-primary">Benefits added Successfully !</div>
                            <?php
                        }
                        else if($added == 'false'){
                            ?>
                ...
                <?php
                        ...
                        ?>
                            <div class="alert alert-primary">No Benefits Found!</div>
                        <?php
                    }
                ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Benefits </h5>
