...
<?php
    ...
    if(isset($_POST['addService'])){
        ...
        if($image!='err'){
            $sql = "INSERT INTO services(name,icon) values('$name','uploads/$image')";
            if($conn->query($sql)){
                $added = 'true';
            }
            else{
                            ...
                            <?php
                                foreach($services as $service){
                                    ...
                                    <tr>
                                        ...
                                        <td><button type='button' class='btn btn-primary' onclick='setEditValue(`<?=$id?>`,`<?=$icon?>`,`<?=$name?>`)' data-toggle='modal' data-target='#edit-modal'><i class='bi bi-pencil'></i></button>&nbsp;<button type='submit' class='btn btn-danger' name="deleteService" value="<?=$id?>" ><i class='bi bi-trash'></i></button></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
